...
agree <- readRDS("models/agree/h1_simple.rds")
neuro <- readRDS("models/neuro/h1_simple.rds")
soi <- readRDS("models/soi_full/h1_simple.rds")
library(cowplot)
...
p_neuro <- plot(equivalence_test(neuro, parameters = c("b_f0", "b_pf", "b_sex1")))  +
  modify("Neuroticism") + remove_x_axis
...
neg_spacer <- -0.11
plot_grid(ncol = 1,  rel_heights = c(1, neg_spacer, 1, neg_spacer, 1, neg_spacer, 1.1, .15), align = "v", axis = "b",
          p_dominance, NULL, p_agree,NULL, p_neuro,NULL, p_soi, legend)
