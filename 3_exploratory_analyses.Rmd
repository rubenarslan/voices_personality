...
behavior <- readRDS("models/behavior/h1_simple.rds")
...
p_extra <- plot(equivalence_test(extra, parameters = c("b_f0", "b_pf", "b_sex1"))) + modify("Extraversion") + remove_x_axis
...
p_attitude <- plot(equivalence_test(attitude, parameters = c("b_f0", "b_pf", "b_sex1"))) +
  modify("SOI behavior") + remove_x_axis
p_desire <- plot(equivalence_test(desire, parameters = c("b_f0", "b_pf", "b_sex1"))) +
  modify("SOI desire") + remove_x_axis
p_behavior <- plot(equivalence_test(behavior, parameters = c("b_f0", "b_pf", "b_sex1"))) +
...
plot_grid(ncol = 1,  rel_heights = c(1, neg_spacer, 1, neg_spacer, 1,neg_spacer, 1,neg_spacer, 1, neg_spacer, 1.1, .15), align = "v", axis = "b",
          p_extra, NULL, p_openn,NULL, p_consc,NULL, p_attitude, NULL, p_desire, NULL, p_behavior, legend)
